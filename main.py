...
from config import bot_token, help_commands, info_text
...
keyboard_info.add(KeyboardButton('/contacts')).add(KeyboardButton('/atlant')).add(KeyboardButton('/location')).add(KeyboardButton('/news'))       #news, contacts, info
